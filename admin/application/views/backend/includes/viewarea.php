			...
			<tbody>
			   <?php foreach($table as $row) { ?>
					<tr>
						...
						<td>
							<a href="<?php echo site_url('site/editarea?id=').$row->id;?>" class="btn btn-primary btn-xs">
								<i class="icon-pencil"></i>
							</a>
							<a href="<?php echo site_url('site/deletearea?id=').$row->id; ?>" class="btn btn-danger btn-xs">
